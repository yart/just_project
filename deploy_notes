...
===============================
    ...
    --------------------------------------------------------------------------
    | new_user@remote$ sudo apt-get install -y libpcre3 libpcre3-dev libperl-|
    ...
    --------------------------------------------------------------------------
    | new_user@remote$ sudo aptitude install -y libpcre3 libpcre3-dev libperl|
    |-dev libxml2-dev libxml2 libxslt-dev curl-ssl libcurl4-openssl-dev      |
    |Reading package lists... Done                                           |
    |Building dependency tree                                                |
    |Reading state information... Done                                       |
...
===============
  ...
  * Adding user and database
  ...
  ----------------------------------------------------------------------------
  | new_user@remote$ psql -Upostgres                                         |
  ...
  Я подумал, и решил, что это резонно. Снова открыл файл /etc/postgresql/8.4/main/pg_hba.conf
  и изменил строку
  ...
  ----------------------------------------------------------------------------
  | new_user@remote$ sudo /etc/init.d/postgresql-8.4 restart                 |
